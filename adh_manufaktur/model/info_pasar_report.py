...
class ReportInfoPasar(models.AbstractModel):
    ...
    _name = 'report.adh_manufaktur.report_infopasar'
    ...
    def get_info_pasar_details(self, date_start =False,date_stop=False):
        ...
        info_pasar_ids = self.env['adhimix.mrp.info.pasar'].search([
        ...
        for info_pasar in info_pasar_ids:
        	nomor_info = info_pasar.name 
                ...
                target_ya = info_pasar.target_ya
                target_tidak = info_pasar.target_tidak
    ...
    def render_html(self, docids, data=None):
        ...
        return self.env['report'].render('adh_manufaktur.report_infopasar', data)
